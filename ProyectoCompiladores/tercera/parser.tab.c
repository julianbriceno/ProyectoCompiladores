...
{
  "$end", "error", "$undefined", "ID", "TYPE", "NUM", "SEMICOLON",
  "LLAVEIZQ", "LLAVEDER", "CORIZQ", "CORDER", "$accept", "program",
  "conjunto", "$@1", "conjunto1", "$@2", "decl", "vector", YY_NULLPTR
};
#endif
...
{
      12,     6,     1,     6,    10,    11,    10,    23,     5,     6,
       9,    14,    13,    12,    21,    17,    18,    22,     0,    19,
...
{
       0,     7,    12,    13,    14,     0,     4,    15,    17,     3,
       7,     8,    17,     6,     9,    18,    16,     6,     5,     9,
      15,    10,     5,     8,    10
};
...
#line 78 "parser.y" /* yacc.c:1646  */
    {
		if(in_TS((yyvsp[-1].sval)))
		{
		
			cout<<"*ERROR: variable ->"<<(yyvsp[-1].sval)<<"<- YA declarada. Linea: "<<lineas<<"*"<<endl;
			cantErrores++;
		}
		else
		{
			if(!strcmp((yyvsp[-2].sval),"int")){
...
#line 117 "parser.y" /* yacc.c:1646  */
    {
		if(in_TS((yyvsp[0].sval)))
		{		
			cout<<"*ERROR: variable ->"<<(yyvsp[0].sval)<<"<- YA declarada. Linea: "<<lineas<<"*"<<endl;
			cantErrores++;
		}
		else
		{
			if(!strcmp((yyvsp[-1].sval),"int")){
				tamano[indice] += 5;
				total += 5;
				parcial += 5;
			}
